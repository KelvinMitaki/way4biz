                ...
                <div className="cart-wrapper">
                        ...
                        <div className="container  cart-product">
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 d-flex secondary-details">
                                    ...
                                    <div id="remove-cart">
                                        <i className="fa fa-trash mr-1"></i><span className="remove-text">Remove</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col5">
                        <div id="cart-total-checkout">
                            ...
                            <button className="btn checkout-btn mb-3 btn-md btn-block">Proceed To Checkout</button>
                            <button className="btn shopping-btn btn-md btn-block">Continue Shopping</button>
                        </div>
                    </div>
                </div>
        )
